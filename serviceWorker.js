  ...
  event.respondWith(
    caches.match(event.request).then((resp) => {
      return resp || fetch(event.request).then((response) => {
        ...
        και χωρίς να έχει πρόσβαση στο ίντερνετ. Γυρνάω αυτή τη σελίδα για να καλύψω όλες τις περιπτώσεις τις offline λειτουργίας, ώστε ο
        χρήστης να παίρνει πάντα απαντήσεις από το site.*/
